<template>
  <q-page class="text-white " style="padding-left: 15px">
    <div class="q-pa-md reviews_main">
      <q-list class="flex">
        <q-item class="star q-mr-md " style="max-width: 350px">
          <q-item-section>
            <q-item-label>Рейтинг: <span class="text-white q-pl-sm text-h5 countNum">5</span></q-item-label>
          </q-item-section>
        ...
        <q-item class="star q-mr-md">
          <q-item-section>
            <q-item-label>Отзывы <span class="text-white q-pl-sm text-h5 countNum">50</span></q-item-label>
          </q-item-section>
        </q-item>
        <q-item class="star">
          <q-item-section>
            <q-item-label>
                          <span v-if="!smallScreen">
                            Сделок: <span class="text-white q-px-md  text-h5" countNum></span>
                          </span>

              Продаж: <span class="text-white q-px-md   text-h5 countNum">20</span>
              покупок: <span class="text-white  q-px-md text-h5 countNum">30</span>
            </q-item-label>
          </q-item-section>
        </q-item>
      </q-list>
    ...
    <div class="reviews_body">
      ...
      <div class=" ">
        <div class="flex items-center justify-between  reviews_body_card q-mb-xl no-wrap  ">
...
window.addEventListener('resize', () => {
  window.innerWidth < 1400 ? smallScreen.value = true : smallScreen.value = false
